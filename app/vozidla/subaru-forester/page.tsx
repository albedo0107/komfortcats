        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/bmw1.png", 1)}>
                <Image
                  src="/bmw1.png"
                  alt="BMW 1"
                  width={400}
              ...
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/bmw2.png", 2)}>
                <Image
                  src="/bmw2.png"
                  alt="BMW 2"
                  width={400}
              ...
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/bmw3.png", 3)}>
                <Image
                  src="/bmw3.png"
                  alt="BMW 3"
                  width={400}
