        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/2-18.png", 1)}>
                <Image
                  src="/2-18.png"
                  alt="Gallery image 1"
                  width={400}
              ...
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/3-18.png", 2)}>
                <Image
                  src="/3-18.png"
                  alt="Gallery image 2"
                  width={400}
              ...
              <div className="aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => openModal("/4-18.png", 3)}>
                <Image
                  src="/4-18.png"
                  alt="Gallery image 3"
                  width={400}
